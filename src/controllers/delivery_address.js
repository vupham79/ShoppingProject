...
export async function createDeliveryAddress(req, res) {
  try {
    ...
    if (deliveryAddress) {
      ...
      return res
        .status(400)
        .json({ message: `Create delivery address '${req.body.id}' failed!` });
    }
  } catch (error) {
    return res.status(400).json({ message: "Error", error: error.message });
  }
...
export async function updateDeliveryAddress(req, res) {
  try {
    ...
    if (deliveryAddress) {
      ...
      return res
        .status(400)
        .json({ message: `Update delivery address ${req.params.id} failed!` });
    }
  } catch (error) {
    return res.status(400).json({ message: "Error", error: error.message });
  }
...
export async function deleteDeliveryAddress(req, res) {
  try {
    ...
    if (deliveryAddress) {
      ...
      return res
        .status(400)
        .json({ message: `Delete delivery address ${req.params.id} failed!` });
    }
  } catch (error) {
    return res.status(400).json({ message: "Error", error: error.message });
  }
